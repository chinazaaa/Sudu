...
class CustomerCompletedSingleOrderScreen extends StatelessWidget {
  final Booking data;

  const CustomerCompletedSingleOrderScreen({Key key, this.data}) : super(key: key);
        ...
        children: [
          ...
          Text(
            ...
            style: TextStyle(
             ...
             SizedBox(height: 10),
          Text(
            "Completed: " + data.completedByCustomer.toString(),
            style: TextStyle(
              fontSize: 14,
