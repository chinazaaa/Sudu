...
import 'package:starter_project/Customer/pages/screens/reset_password/reset_password_screen.dart';
...
class CustomerForgotPage extends StatelessWidget {
  ...
  forgotPassword(context) async {
    ...
    if (success) {
      //go to otp page
      Navigator.push(
          context, MaterialPageRoute(builder: (context) => CustomerResetPasswordScreen(email.text)));
    } else {
      //Do nothing
    }
  }
