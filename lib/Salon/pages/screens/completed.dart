  ...
  Widget build(BuildContext context) {
    ...
    return ResponsiveState(
      ...
      dataFetchedWidget: ListView(
        ...
        children: [
          ...model.salonCompletedOrders.map((e) {
            double totalPrice = 0;
            for(String price in e.servicePrice){
              totalPrice = totalPrice + (double.tryParse(price) ?? 0);
            }
            return InkWell(
              onTap: ()=> Navigator.push(context, MaterialPageRoute(builder: (context)=> CompletedSingleOrderScreen(data: e,))),
              child: Container(
               decoration: BoxDecoration(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 5),
                      Text(
                        'Services booked: ${e.serviceName.join(", ")}',
                        style: TextStyle(
                          fontSize: 14,
                        ),
                      ),
