...
class SalonUncompletedMoreDetails extends StatefulWidget {
  final Booking data;
  final bookingID;

  const SalonUncompletedMoreDetails({Key key, this.data,this.bookingID}) : super(key: key);
  @override
  _SalonUncompletedMoreDetailsState createState() => _SalonUncompletedMoreDetailsState();
}

class _SalonUncompletedMoreDetailsState extends State<SalonUncompletedMoreDetails> {
  @override
  void initState() {
    super.initState();
